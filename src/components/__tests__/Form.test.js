...
//make a fakeState?
  ...
  it("renders with initial student name", () => {
    const { getByTestId } = render(<Form interviewers={interviewers} name={student} student={student}/>);
  ...
  it("validates that the interviewer cannot be null", () => {
    ...
    const onSave = jest.fn();
    const { getByText } = render(<Form interviewers={interviewers} onSave={onSave} student={student} interviewer={null}/>)
    fireEvent.click(getByText("Save"));
  ...
  //   const onSave = jest.fn();
  //   const { queryByText, getByText } = render(<Form interviewers={interviewers} onSave={onSave} student={student} interviewer={1}/>)
  //   fireEvent.click(getByText("Save"));
